...
type CartClient interface {
	GetCartByUserId(ctx context.Context, in *GetCartByUserIDRequest, opts ...grpc.CallOption) (*GetCartResponse, error)
}
...
func (c *cartClient) GetCartByUserId(ctx context.Context, in *GetCartByUserIDRequest, opts ...grpc.CallOption) (*GetCartResponse, error) {
...
type CartServer interface {
	GetCartByUserId(context.Context, *GetCartByUserIDRequest) (*GetCartResponse, error)
...
func (UnimplementedCartServer) GetCartByUserId(context.Context, *GetCartByUserIDRequest) (*GetCartResponse, error) {
...
func _Cart_GetCartByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServer).GetCartByUserId(ctx, req.(*GetCartByUserIDRequest))
	}
