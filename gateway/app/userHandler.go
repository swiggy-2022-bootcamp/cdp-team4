...
func (uh userHandler) GetAllUsers(c *gin.Context) {
	...
	userServiceURI := os.Getenv("USER_SERVICE_URI") + "/users"
...
func (uh userHandler) UpdateUser(c *gin.Context) {
	...
	req, err2 := http.NewRequest("PATCH", userServiceURI, bytes.NewBuffer(userJSON))
...
func (uh userHandler) DeleteUser(c *gin.Context) {
	...
	req, err2 := http.NewRequest("DELETE", userServiceURI, bytes.NewBuffer(userJSON))
